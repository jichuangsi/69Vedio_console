...
) ENGINE = InnoDB AUTO_INCREMENT = 85 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 系统配置' ROW_FORMAT = Compact;
...
INSERT INTO `ms_admin_config` VALUES (24, 'video', '前置广告内容', 'pre_ad', 'http://www.msvod.cc/common/msvodx/images/dq.png', '前置广告内容');
INSERT INTO `ms_admin_config` VALUES (25, 'video', '前置广告外链', 'pre_ad_url', 'http://msvodx.com', '前置广告外链');
INSERT INTO `ms_admin_config` VALUES (26, 'video', '暂停广告内容', 'suspend_ad', 'http://www.msvod.cc/common/msvodx/images/dq.png', '暂停广告内容');
INSERT INTO `ms_admin_config` VALUES (27, 'video', '暂停广告外链', 'suspend_ad_url', 'http://msvodx.com', '暂停广告外链');
...
INSERT INTO `ms_admin_config` VALUES (39, 'attachment', '阿里云AccessKeyId', 'aliyun_accesskey', 'LTAIQAR8DvkLakuu', '');
INSERT INTO `ms_admin_config` VALUES (40, 'attachment', '阿里云AccessKeySecret', 'aliyun_secretkey', '', '');
INSERT INTO `ms_admin_config` VALUES (41, 'attachment', '阿里云Bucket', 'aliyun_bucket', 'vodx', '');
INSERT INTO `ms_admin_config` VALUES (42, 'attachment', 'webServer地址', 'web_server_url', 'http://v.meisicms.com', '');
...
INSERT INTO `ms_admin_config` VALUES (61, 'base', '系统支付方式码', 'system_payment_code', 'nativePay', NULL);
...
INSERT INTO `ms_admin_config` VALUES (68, 'sms', '短信api密码', 'sms_api_password', '123456', '短信接口密码');
...
INSERT INTO `ms_admin_config` VALUES (76, 'base', '手机网站logo', 'site_logo_mobile', 'http://www.msvodx.com/logo.png', NULL);
...
INSERT INTO `ms_admin_config` VALUES (83, 'base', '首页内容个数', 'homepage_resource_num', '20', '首页上每个栏目内容的显示个数');
INSERT INTO `ms_admin_config` VALUES (84, 'base', '卡密码购买链接', 'buy_cardpassword_uri', '##', '用于指引会员在卡密平台上购买本站卡密');
...
CREATE TABLE `ms_agent_apply`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 33 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员代理审核记录表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_atlas_good_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 27 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '图集收藏日志表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_atlas_watch_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 87 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '相册观看日志表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for ms_bd_cofing
-- ----------------------------
DROP TABLE IF EXISTS `ms_bd_cofing`;
CREATE TABLE `ms_bd_cofing`  (
  `id` int(11) NOT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '链接名',
  `type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '数据库类型',
  `hostname` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '服务器地址',
  `hostport` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '端口号',
  `database` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '数据库名称',
  ...
  `prefix` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '表前缀',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ms_card_password`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2034 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '卡密表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_comment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 497 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统评论表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_gold_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 570 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '金币明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_gold_package`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '金币套餐表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_image_collection`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 149 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '图片收藏表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 813 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登陆日志表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `ms_login_setting` VALUES (1, 'qq', 'QQ登录', '[{\"name\":\"APPID\",\"type\":\"text\",\"value\":\"201459043\",\"desc\":\"APPID\"},{\"name\":\"APPKey\",\"type\":\"text\",\"value\":\"ee4f10c0c0404bf61de486cf1ec717be\",\"desc\":\"APPKey\"}]', 1, 1514888879, 1519263473);
INSERT INTO `ms_login_setting` VALUES (2, 'wechat', '微信登录', '[{\"name\":\"APPID\",\"type\":\"text\",\"value\":\"asdada\",\"desc\":\"APPID\"},{\"name\":\"APPKey\",\"type\":\"text\",\"value\":\"23242342\",\"desc\":\"APPKey\"}]', 1, 1514888906, 1515029281);
...
CREATE TABLE `ms_member`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `ms_notice`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公告表' ROW_FORMAT = Compact;
...
CREATE TABLE `ms_novel_collection`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 49 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '小说收藏表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_novel_good_log`  (
  ...
  `add_time` int(10) DEFAULT NULL COMMENT '点赞时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 24 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '小说收藏日志表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_novel_watch_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 99 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '小说阅读日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_sign`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 86 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员签到日志表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_video_collection`  (
  ...
  `collection_time` int(10) DEFAULT 0 COMMENT '收藏时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 72 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '视频收藏表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_video_good_log`  (
  ...
  `add_time` int(10) DEFAULT NULL COMMENT '点赞时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 72 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '视频点赞记录表' ROW_FORMAT = Fixed;
...
CREATE TABLE `ms_video_watch_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1058 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '视频观看日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ms_website_group_setting`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '站群配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ms_website_group_setting
-- ----------------------------
INSERT INTO `ms_website_group_setting` VALUES (5, 'payer.free.ngrok.cc', 'https://vodx.oss-cn-shenzhen.aliyuncs.com/20180307/4WDddTtMKGpt45QCxrQmKMKtZQMsK7J5.png', 'A3的短视频站', 'A3的短视频站', 'A3的短视频站', 1520922411, 'https://vodx.oss-cn-shenzhen.aliyuncs.com/20180307/4WDddTtMKGpt45QCxrQmKMKtZQMsK7J5.png', 'Msvodx|http://www.msvod.cc\r\n京东|http://www.msvod.cc', '<script>console.log(\'统计代理\')</script>', 'ICP信息');
