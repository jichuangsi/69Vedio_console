OpenInstall = function (e, n, t) {
    ...
    function c(e) {
        var n = new t,
            ...
            i = e.url,
            o = e.method;
        r && "string" != typeof r && (r = A.stringify(r)), "POST" != o && r && (i = i + (i.indexOf("?") > -1 ? "&" : "?") + r, r = null), n.onreadystatechange = function () {
            if (4 == n.readyState) {
                if (200 == n.status) {
        ...
        try {
            n.open(o, i, !1 !== e.async), n.withCredentials = !0;
            try {
    ...
    function l(n) {
        R(function (t) {
            ...
            document.getElementById('sw').innerHTML = r;
            document.getElementById('sh').innerHTML = i;
            document.getElementById('sp').innerHTML = o;
            document.getElementById('gv').innerHTML = a.version;
            document.getElementById('gr').innerHTML = a.renderer;
        ...
        for (var v, g, m = !1, b = r ? r + ((new Date).getTime() + (i || 1)) + "-" : null, h = 0; h < p.length; h++) {
            try {
                if (v = p[h], y && (v.style.position = "absolute", v.style.top = "-100px"), n.body.appendChild(v), "SELECT" === v.nodeName) v.focus();
                    ...
                    C || v.setAttribute("readonly", ""), v.select(), v.setSelectionRange(0, v.value.length), C || v.removeAttribute("readonly")
                } else {
                    v.hasAttribute("contenteditable") && v.focus(), b && v.setAttribute("class", b), g = e.getSelection();
                    var E = n.createRange();
                    E.selectNode(v), g.removeAllRanges(), g.addRange(E)
                }
                m = n[s](d)
            } catch (e) {
                m = !1
    ...
    var p = 2,
        ...
        I = function (e, t) {
            ...
            function i(e, n, t) {console.log(p);
                p.run(function () {
                    t = t || {}, n && k && (e = !1), A && n && (m(), P = s(A, T, w));
                    var i;
                    n && (i = r, N && c({
                        method: "POST",
                        url: N
                ...
                function () {
                    ...
                    l(function (r) {
                        ...
                        c({
                            ...
                            success: function (e) {
                            	console.log(e);
                            	console.log(e.fu.substring(e.fu.indexOf('c/')+2));
                            	console.log(decodeURIComponent(e.fu.substring(e.fu.indexOf('c/')+2)));
                                g(function () {
    ...
    }, I.parseUrlParams = r, I.docReady = g, I.server = "https://openinstall.io", I.wakeupOrInstall = function (e, n, t, r, i) {
        n ? f(e, n, function () {
            S[t](r)
        }, i) : S[t](r)
    }, I
